...
class SalesDataAnalyzer:
    ...
    def load_data(self, file_path):
        ...
        try:
            ...
            print(f"Dataset loaded successfully from: {abs_path}")
    ...
    def descriptive_statistics(self):
        ...
        if 'Product' in self.data.columns and 'Profit' in self.data.columns:
    ...
    def visualize_data(self):
        ...
        try:
            ...
            plt.savefig("anu_plot.png")
            plt.show()

            self.last_plot = plt.gcf()
            print("Graph saved as 'anu_plot.png' successfully.")
